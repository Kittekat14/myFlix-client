  ...
  constructor() {
    ...
    this.state = {  //MainView's state has objects --> movies, selectedMovie
      movies: [
        ...
        { _id: 2, title: 'The Shawshank Redemption', description: 'Two imprisoned men bond over a number of years, finding solace and eventual redemption through acts of common decency.', imageUrl: 'C:/Users/ASUS/Documents/careerfoundry/myFlix-client/img/TheShawshankRedemption.jpg'},
